...
def parse_single_full_time_course(course_soup: Tag) -> Course:
    return Course(
...
def parse_single_part_time_course(course_soup: Tag) -> Course:
    return Course(
        name=course_soup.select_one(".typography_landingH3__vTjok").text,
        short_description=course_soup.select_one(
            ".typography_landingP1__N9PXd"
...
def get_full_time_courses() -> list[Course]:
    ...
    return [parse_single_full_time_course(course_soup)
...
def get_part_time_courses() -> list[Course]:
    ...
    return [parse_single_part_time_course(course_soup)
